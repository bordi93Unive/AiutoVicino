...
public class AnnuncioDetailFragment extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Gson gson = new Gson();
        String json = (String)b.get("annuncio");

        if(json != null && !json.equals("")) {
            annuncio = gson.fromJson(json, AnnuncioModel.class);
        }
        ...
        if(annuncio == null){
            ...
            binding.textPartecipanti.setText((String.valueOf(annuncio.partecipantsNumber)));
